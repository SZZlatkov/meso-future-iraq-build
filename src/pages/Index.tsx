...
const Index = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 md:pt-40 md:pb-28 relative bg-gradient-to-br from-meso-DEFAULT to-meso-light text-white">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg">We deploy capital and expertise to create new industries and sustainable jobs beyond oil.</p>
        </div>
      </Section>
      ...
      >
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-xl font-bold mb-4">Banking & Insurance</h3>
            <div className="h-1 w-16 bg-meso-accent mb-4"></div>
            <p className="text-gray-600">Modernizing financial services with digital-first solutions</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-xl font-bold mb-4">E-Commerce & Logistics</h3>
            <div className="h-1 w-16 bg-meso-accent mb-4"></div>
            <p className="text-gray-600">Building retail infrastructure for the digital economy</p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200">
            <h3 className="text-xl font-bold mb-4">Healthcare & Technology</h3>
            <div className="h-1 w-16 bg-meso-accent mb-4"></div>
            <p className="text-gray-600">Enhancing healthcare delivery through innovative technology</p>
          </div>
        </div>
        <div className="text-center max-w-3xl mx-auto mt-12">
          <p className="text-lg italic">Our tech powers our bank. Our bank funds our ventures. Our ventures build the future.</p>
        </div>
      </Section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            <div className="flex gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Pipeline Creation</h3>
                <p className="text-gray-600">Six Sigma-driven market analysis to identify opportunities</p>
              </div>
            </div>
            <div className="flex gap-6">
              <div className="flex-shrink-0 mt-1">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Entrepreneurship Development</h3>
                <p className="text-gray-600">In-house training, MVP support to build strong founding teams</p>
              </div>
            </div>
            <div className="flex gap-6">
              <div className="flex-shrink-0 mt-1">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Ecosystem Building</h3>
                <p className="text-gray-600">Regulatory support, public-private partnerships to enable growth</p>
              </div>
            </div>
            <div className="flex gap-6">
              <div className="flex-shrink-0 mt-1">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">Operational Execution</h3>
                <p className="text-gray-600">End-to-end support from capital to scale for sustainable growth</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <ul className="space-y-3 text-left mx-auto max-w-lg mb-8">
            <li className="flex items-start">
              ...
              <span>Ex-MENA VC & PE leaders</span>
            </li>
            <li className="flex items-start">
              <span className="text-meso-accent mr-2">•</span>
              <span>Silicon Valley tech veterans</span>
            </li>
            <li className="flex items-start">
              <span className="text-meso-accent mr-2">•</span>
              <span>On-ground team in Baghdad with government and academic influence</span>
            </li>
          </ul>
        </div>
      </Section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <div className="text-2xl font-bold mb-4">
                <span className="text-white">MESO</span>
                <span className="ml-1 text-meso-accent">Capital</span>
              </div>
